...
const sampleProjects: Project[] = [
  {
    ...
    client: 'Sarah Martin',
    description: 'Couverture photo et vid\xE9o du mariage',
    date: '2024-06-15',
    budget: 1500,
    status: 'Tournage',
  },
  {
    id: 2,
    name: 'Clip promo Maison d\'h\xF4tes',
    client: 'Le Beau G\xEEte',
    description: 'R\xE9alisation d\'une vid\xE9o publicitaire',
    date: '2024-05-01',
    budget: 2000,
    status: 'Montage',
  },
...
const statusColors: Record<Status, string> = {
  ...
  'Pr\xEAt': 'bg-green-200 text-green-700',
  'Envoy\xE9': 'bg-blue-500 text-white',
  'Termin\xE9': 'bg-gray-500 text-white',
};
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-60 bg-white shadow-md">
        ...
        <nav className="mt-8 flex flex-col space-y-2">
          <a className="px-6 py-2 hover:bg-gray-100" href="#">Tableau de bord</a>
          <a className="px-6 py-2 bg-gray-200 font-semibold" href="#">Projets</a>
          <a className="px-6 py-2 hover:bg-gray-100" href="#">Clients</a>
          <a className="px-6 py-2 hover:bg-gray-100" href="#">Organisation</a>
          <a className="px-6 py-2 hover:bg-gray-100" href="#">Ressources</a>
        </nav>
      </aside>
      ...
      <main className="flex-1 p-8">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold">Projets r\xE9cents</h1>
          <a
            href="/new-project"
